					...
					<div
						...
						<div
							...
							<div style="padding-left: 20px; bottom: 30px;">
								<div class="club_profile_name_1">어쿠스틱스</div>
								<div class="club_profile_name_2">
									<img src=".\resources\images\club_spot.svg"
								...
								<div class="club_profile_name_3"
									...
									<div>
										<span class="club_profile_name_4">회장</span>이우준
									</div>
						...
						<div class="content" style="padding-top: 25px;">
							<div
								...
								<span class="club_univ_name">건국대학교(글로컬)</span> <span
									class="club_type_name">중앙동아리</span>
							...
							<div class="content"
								...
								<div id="intro_content"
									...
									매 학기마다 정기적으로 버스킹/공연을 하고 있으며, <br>기타 초심자/입문자를 위해서 기타교실도
									운영하고 있습니다.
								</div>
							</div>
							<!--동아리 태그-->
					...
					<div class="custom-block custom-block-profile-front custom-block-profile text-center bg-white">
						...
						<div
							...
							<div class="swiper-wrapper"
								...
								<div class="swiper-slide" data-hash="1" style="width: 840px; margin-right: 10px;"
									...
									<div class="row" style="margin: 0 20px;">
										...
										<div class="col">
											<div class="square"
												style="background-image: url(https://mycampus-storage.s3.ap-northeast-2.amazonaws.com/s/shared/temporary/2023/07/11/e8b0c1a6-4c38-4985-b96d-b80f68bb15d4.jpeg); background-size: cover; background-position: center;"
												onclick="show_loader();location.href='/web/board/12345'"></div>
										</div>
										...
										<div class="col">
											<div class="square"
												style="background-image: url(https://mycampus-storage.s3.ap-northeast-2.amazonaws.com/s/shared/temporary/2023/06/16/c8286b8c-76b1-4976-bfa4-b62b8321d724.jpeg); background-size: cover; background-position: center;"
												onclick="show_loader();location.href='/web/board/11607'"></div>
										</div>
										...
										<div class="col">
											<div class="square"
												style="background-image: url(https://mycampus-storage.s3.ap-northeast-2.amazonaws.com/s/shared/temporary/2023/06/14/399f394d-87bd-4fe1-a48b-25a678bcc503.jpeg); background-size: cover; background-position: center;"
												onclick="show_loader();location.href='/web/board/11496'"></div>
										</div>
										...
										<div class="col">
											<div class="square"
												style="background-image: url(https://mycampus-storage.s3.ap-northeast-2.amazonaws.com/s/shared/temporary/2023/06/16/89d04d2a-bcd1-4d91-81fb-07eec9d424fe.jpeg); background-size: cover; background-position: center;"
												onclick="show_loader();location.href='/web/board/11395'"></div>
										</div>
										...
										<div class="col">
											<div class="square"
												style="background-image: url(https://mycampus-storage.s3.ap-northeast-2.amazonaws.com/s/shared/temporary/2023/06/09/32c7a7a9-1c2c-4fb1-b6f9-f433bb7279d9.jpeg); background-size: cover; background-position: center;"
												onclick="show_loader();location.href='/web/board/11311'"></div>
										</div>
								...
								<div class="swiper-slide" data-hash="2" style="width: 840px; margin-right: 10px; text-align: left;"
									...
									<div class="row" style="margin: 0 20px;">
										...
										<div onclick="alert('소속 동아리원이 아닙니다.')"
											...
											<div
												...
												<div
													...
													<div class="club_board_title">오늘까지</div>
													<div class="club_board_content">2차수강바구니</div>
												</div>
											</div>
											<div
												...
												<div
													...
													<div class="club_board_name">봄봄본</div>
												</div>
												<div
													style="display: flex; flex-direction: row; align-items: center;">
										...
										<div onclick="alert('소속 동아리원이 아닙니다.')"
											...
											<div
												...
												<div
													...
													<div class="club_board_content">안해도 되는걸 좋아해야하는건가...
														슬퍼해야 하는건가...</div>
												</div>
											</div>
											<div
												...
												<div
													...
													<div
														style="width: 20px; height: 20px; border: 1px solid #F5F5F5F5; border-radius: 8px; margin-right: 6px;">
														<img class="user_img" src="/s/front/images/maku/2.jpg">
													</div>
													<div class="club_board_name">김쟨</div>
												</div>
												<div
													style="display: flex; flex-direction: row; align-items: center;">
													<div class="club_board_name"
										...
										<div onclick="alert('소속 동아리원이 아닙니다.')"
											...
											<div
												...
												<div
													style="width: 95%; text-overflow: ellipsis; white-space: nowrap;">
													<div class="club_board_title">태풍</div>
													<div class="club_board_content">조심하세요!</div>
												</div>
											</div>
											<div
												style="display: flex; flex-direction: row; justify-content: space-between; align-items: center;">
												<div
													...
													<div
														style="width: 20px; height: 20px; border: 1px solid #F5F5F5F5; border-radius: 8px; margin-right: 6px;">
														<img class="user_img" src="/s/front/images/maku/6.jpg">
													</div>
													<div class="club_board_name">딸기왕국</div>
												</div>
												<div
													style="display: flex; flex-direction: row; align-items: center;">
													<div class="club_board_name"
										...
										<div onclick="alert('소속 동아리원이 아닙니다.')"
											...
											<div
												...
												<div
													style="width: 95%; text-overflow: ellipsis; white-space: nowrap;">
													<div class="club_board_title">출근 11분째</div>
													<div class="club_board_content">퇴근하고 싶다</div>
												</div>
											</div>
											<div
												style="display: flex; flex-direction: row; justify-content: space-between; align-items: center;">
												<div
													...
													<div class="club_board_name">Yehni</div>
												</div>
												<div
													style="display: flex; flex-direction: row; align-items: center;">
													<div class="club_board_name"
