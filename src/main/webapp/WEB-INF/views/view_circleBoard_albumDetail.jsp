			...
			<main
				...
				<div
					...
					<div class="board" style="margin-bottom: 1rem;">
									...
									<div
										...
										<div style="margin-left: 10px;">
											...
											<div onclick="show_loader();location.href='/web/user/26224'"
												...
												<div class="user_name"
													style="display: flex; align-items: center;">봄봄본</div>
											</div>


										</div>
										<!--작성 날짜-->
										<div class="board_created">2023.06.16 11:54</div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="board" style="padding: 0 20px; margin-bottom: 40px;">
							<div class="activity_info_content mb-5 mt-3"
								style="min-height: auto;">
								<div id="linktest"
									style="word-break: break-word; text-align: left;">2학기도
									화이팅</div>
							</div>
						</div>
						...
						<div class="mt-4"
							...
							<div
								...
								<div class="heart" id="like_icon"
									onclick="$.app.web.board.board_like('5514', '11607')"></div>
								<div id="like_cnt"
												...
												<div class="c_col_02" style="line-height: 1;">
													<div id="reply_02_14266">
														<span class="rw"
															...
															style="white-space: break-spaces; word-break: break-word; text-align: left;">큐티해</span>
													</div>
												</div>
												<div>
								...
								<div class="reply_div" style="width: calc(100% - 60px);">
									<div class="reply_input_tbl">
										<textarea placeholder=" 댓글을 입력해주세요." class="reply_input_box"
											name="comment" id="comment" style="height: 35px !important; resize: none; border: none;"></textarea>
